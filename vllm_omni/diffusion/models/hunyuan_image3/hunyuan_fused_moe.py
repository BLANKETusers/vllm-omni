...
class HunyuanFusedMoEDefault:
    ...
    *directly* from ``__new__`` so the parent MoE block registers it as a real
    ...
    def __new__(cls, *, prefix: str = "", **kwargs: Any) -> Any:
        ...
        # with the official HunyuanImage-3.0 repo (default: flashinfer_trtllm).
        ...
        logger.warning("HunyuanFusedMoEDefault: moe_backend after set = %s", vllm_config.kernel_config.moe_backend)
